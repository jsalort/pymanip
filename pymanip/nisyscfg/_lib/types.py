...
NISysCfgResourcePropertyType = {
    ...
    rp.VendorName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None), 
    rp.ProductId: (ctypes.c_uint, 0, None, ctypes.byref, None),
    rp.ProductName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.SerialNumber: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.FirmwareRevision: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.IsNIProduct: (NISysCfgBool, 0, None, ctypes.byref, None),
    rp.IsSimulated: (NISysCfgBool, 0, None, ctypes.byref, None),
    rp.ConnectsToLinkName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.InternalCalibrationLastTime: (NISysCfgTimestampUTC, [0,0,0,0], None, ctypes.byref, None),
    ...
    rp.CalibrationComments: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.TcpHostName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpMacAddress: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpIpAddress: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpDeviceClass: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.ProvidesLinkName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.NumberOfSlots: (ctypes.c_int, 0, None, ctypes.byref, None),
    rp.SupportsFirmwareUpdate: (NISysCfgBool, 0, None, ctypes.byref, None),
    rp.FirmwareFilePattern: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.HardwareRevision: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.CpuModelName: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.CalibrationCurrentPassword: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.CalibrationNewPassword: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    #rp.SysCfgAccess: NISysCfgAccessType,
    #rp.AdapterType: NISysCfgAdapterType,
    rp.MacAddress: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    #rp.AdapterMode: NISysCfgAdapterMode,
    #rp.TcpIpRequestMode: NISysCfgIpAddressMode,
    rp.TcpIpv4Address: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpIpv4Subnet: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpIpv4Gateway: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.TcpIpv4DnsServer: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.WlanBssid: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.WlanCurrentLinkQuality: (ctypes.c_uint, 0, None, ctypes.byref, None),
    rp.WlanCurrentSsid: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    ...
    rp.WlanClientCertificate: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.WlanSecurityIdentity: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    rp.WlanSecurityKey: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
    #rp.SystemStartTime: NISysCfgTimestampUTC ,
    #rp.CurrentTime: NISysCfgTimestampUTC,
    rp.TimeZone: (ctypes.c_char_p, NISYSCFG_SIMPLE_STRING_LENGTH, ctypes.create_string_buffer, lambda x: x, None),
