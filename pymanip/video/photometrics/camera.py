    ...
    async def get_image(self, loop, timeout):
        ...
        while monotonic() - start_time < timeout:
            ...
            if frameStatus == 'READOUT_FAILED':
                ...
                try:
                    frame, fps, frame_count = await asyncio.wait_for(future, timeout=timeout, loop=loop)
        ...
        print("Out of the loop after", monotonic() - start_time, "second with frame status", frameStatus)
        raise CameraTimeout
        ...
        try:
            ...
            while count < num:
                ...
                stop_signal = yield MetadataArray(
                    ...
                    metadata={
                        "counter": frame_count,
                        "timestamp": frame['meta_data']["frame_header"]["timestampBOF"]/1e12,
                    },
                )
                if count == 0:
