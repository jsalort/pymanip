...
def datestr2epoch(string):
    ...
    if isinstance(string, str):
        ...
        if not date.tzinfo:
            raise TypeError("datestr with no timezone information "
                            "is ambiguous !")
        return (date -
                datetime.datetime(1970, 1, 1,
                                  tzinfo=tzutc())).total_seconds()
    else:
        dlist = []
        for s in string:
            s = s.upper()
...
if __name__ == '__main__':
    ...
    for datestr in ['2016-02-25T17:36UTC', '2016-02-25T18:36UTC+1',
                    '2016-02-25T18:36UTC+01', '2016-02-25T18:36UTC+0100',
                    '2016-02-25T19:36UTC+02:00', '2016-02-25T18:36+0100',
