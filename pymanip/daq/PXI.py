...
def read_analog(Scope_slot, Scope_channels, DAQmx_channels, volt_range, samples_per_chan, sample_rate):
    ...
    task.CfgSampClkTiming('OnboardClock', sampling, PyDAQmx.DAQmx_Val_Rising,
    ...
    task.ReadAnalogF64(
        samples_per_chan, timeout, PyDAQmx.DAQmx_Val_GroupByChannel, data_daqmx,
        buffer_size_in_samps, PyDAQmx.byref(samples_per_chan_read), None)
