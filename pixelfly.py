...
def PCO_GetFrameRate(handle):
    ...
    ret_code = f(handle, ctypes.byref(FrameRateStatus),
                ctypes.byref(FrameRate), ctypes.byref(FrameRateExposure))
    PCO_manage_error(ret_code)
    return FrameRateStatus.value, FrameRate.value, FrameRateExposure.value
    
def PCO_SetFrameRate(handle: int,
    ...
    ret_code = f(handle, ctypes.byref(FrameRateStatus),
                FrameRateMode, ctypes.byref(dwFrameRate),
